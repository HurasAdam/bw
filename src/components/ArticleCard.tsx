...
const ArticleCard = () => {
  return (
    <div className="flex items-center justify-center min-h-[80px] h-fit mb-4 rounded bg-gray-50 dark:bg-gray-800">
      <ul className='w-full h-full flex justify-between p-4 items-center'>
        <li className='flex-shrink-0 bg-orange-200 px-2 py-1 text-center'>A1235</li>

        <li className='flex-1 bg-white px-4 py-1 text-left'>Jak wykonać promocję przedszkolaka</li>

        <li className='flex-2 max-w-[33%] bg-pink-200 flex flex-wrap gap-x-1 gap-y-1'>
